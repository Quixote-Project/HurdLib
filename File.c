 ...
 * External public method.
 *
 * This method implements the ability to check the error code that
 * was generated by an I/O operation.
 *
 * \param this	A pointer to the object whose error status is to
 *		be returned.
 *
 * \return	The numeric value of the last error code that was
 *		generated by the object.
 */

static int error(CO(File, this))
